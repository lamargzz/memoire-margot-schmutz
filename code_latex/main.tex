...
\definecolor{rougeEntreprise}{HTML}{C00000}
\definecolor{rougeCorp}{HTML}{C00000}
\definecolor{rougeEnt}{HTML}{C00000}
\definecolor{rosePale}{HTML}{F7E4E4}
\definecolor{rougeClair}{HTML}{E8A0A0}
\definecolor{grisTab}{HTML}{F2F2F2}
...
\titleformat{\chapter}[display]
  ...
  {\vspace*{0pt}\chaptertitlename\ \thechapter} % Espace au-dessus + Texte "Chapitre X"
  {15pt} % Espace vertical entre "Chapitre X" et le titre du chapitre
...
\include{1_preambule/declaration_ia}
\include{1_preambule/acronymes}
