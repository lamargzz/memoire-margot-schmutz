...
Le mémoire est organisé en cinq parties. La première partie présente le cadre réglementaire de
Solvabilité~II et les principes de calcul du Best Estimate. La deuxième partie décrit le modèle ALM
interne utilisé ainsi que la méthodologie de construction de la base de données. La troisième partie
présente les modèles de machine learning retenus et la méthodologie d'apprentissage. La quatrième
partie est consacrée à l'analyse des résultats et à l'identification des principaux facteurs expliquant
les écarts observés~; la robustesse des modèles y fait l'objet d'une double validation, d'une part sur
une seconde base de données construite à partir d'un jeu d'hypothèses distinct, d'autre part au
travers une analyse de variation visant à vérifier leur capacité à reproduire l'évolution de l'écart
entre deux dates de valorisation du portefeuille. Enfin, la dernière partie présente les limites de l'étude
ainsi que les perspectives d'amélioration possibles.